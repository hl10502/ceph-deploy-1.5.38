...
def get(hostname,
    ...
    module.is_el = module.normalized_name in ['redhat', 'centos', 'fedora', 'scientific', 'oracle', 'virtuozzo', 'WinServer', 'XenServer']
    module.is_rpm = module.normalized_name in ['redhat', 'centos',
                                               'fedora', 'scientific', 'suse', 'oracle', 'virtuozzo', 'WinServer', 'XenServer']
...
def _normalized_distro_name(distro):
    ...
    if distro.startswith(('redhat', 'red hat')):
        ...
        return 'suse'
    elif distro.startswith(('centos', 'winserver', 'xenserver')):
        return 'centos'
